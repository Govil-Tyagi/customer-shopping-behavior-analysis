...
Data cleaning and preprocessing were performed using Python and Pandas in Jupyter Notebook.
[customer behavior  analysis (1).ipynb](https://github.com/user-attachments/files/32087200/customer.behavior.analysis.1.ipynb)
...

{
 "cells": [
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "0          Venmo            Fortnightly  Middle_Aged  \n",
       "1           Cash            Fortnightly        Young  \n",
       "2    Credit Card                 Weekly  Middle_Aged  \n",
       "3         PayPal                 Weekly        Young  \n",
       "4         PayPal               Annually  Middle_Aged  "
      ]
     },
     "execution_count": 18,
     "metadata": {},
  ...
  },
  {
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       "     frequency_of_purchases  purchase_frequeny_days\n",
       "0               Fortnightly                      14\n",
       "1               Fortnightly                      14\n",
       "2                    Weekly                       7\n",
       "3                    Weekly                       7\n",
   ...
   "source": [
    "df[[\"frequency_of_purchases\",\"purchase_frequeny_days\"]]"
   ]
  },
  {
   "cell_type": "code",
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "Requirement already satisfied: pymysql in c:\\users\\codertyagi\\anaconda3\\lib\\site-packages (1.2.0)\n",
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "Data succesfully loaded into table'customer' in database 'projectDA'.\n"
     ]
    }
   ],
   "source": [
